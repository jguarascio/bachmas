          ...
          <div className="space-y-8">
            <section className="bg-bach-brown/5 p-6 rounded-lg">
              ...
              <p className="text-bach-brown leading-relaxed">
                ...
                timeless works together. From the Goldberg Variations to the Brandenburg Concertos, the music of 
                Bach brings us together in harmony and celebration.
              </p>
            </section>
            ...
            <section className="bg-bach-brown/5 p-6 rounded-lg">
              ...
              <p className="text-bach-brown leading-relaxed">
                Children rush downstairs in the morning to find gifts under the harpsichord. Each gift is carefully 
            ...
            <section className="bg-bach-brown/5 p-6 rounded-lg">
              ...
              <p className="text-bach-brown leading-relaxed">
                As the day draws to a close, everyone joins in singing Bachmas chorales together. The rich 
